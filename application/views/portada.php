...
?>
<div class="col-md-3"><a class="btn btn-default btn-lg btn-block" href="<?php echo base_url($enlace_base_planilla . $sectores[$i]->url); ?>"><?php echo $sectores[$i]->nombre; ?></a></div>
<?php }} ?>
</div>
